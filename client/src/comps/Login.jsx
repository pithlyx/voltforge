...
function Login({ loggedIn, setLoggedIn }) {
	...
	return (
		<div className="flex flex-col items-center justify-center h-screen w-screen" style={{ backgroundColor: '#475569' }}>
			<h1 className="text-3xl font-bold mb-4 text-orange-600">Login</h1>
			<form className="bg-white p-6 rounded shadow-md" onSubmit={handleLogin} style={{ backgroundColor: '#94A3B8' }}>
				{!loggedIn && (
					<>
						<input
